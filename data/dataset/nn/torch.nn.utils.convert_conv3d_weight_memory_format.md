...
torch.nn.utils. convert_conv3d_weight_memory_format ( *module*  , *memory_format* ) [source](https://github.com/pytorch/pytorch/blob/v2.8.0/torch/nn/utils/memory_format.py#L90) 
...
Parameters
:   * **module** ( [*nn.Module*](torch.nn.Module.html#torch.nn.Module "torch.nn.Module")  ) – `nn.Conv3d`  & `nn.ConvTranspose3d`  or container `nn.Module`
