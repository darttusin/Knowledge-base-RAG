...
*class* torch.nn. LazyBatchNorm1d ( *eps = 1e-05*  , *momentum = 0.1*  , *affine = True*  , *track_running_stats = True*  , *device = None*  , *dtype = None* ) [source](https://github.com/pytorch/pytorch/blob/v2.8.0/torch/nn/modules/batchnorm.py#L344) 
:   A [`torch.nn.BatchNorm1d`](torch.nn.BatchNorm1d.html#torch.nn.BatchNorm1d "torch.nn.BatchNorm1d")  module with lazy initialization. 

Lazy initialization based on the `num_features`  argument of the [`BatchNorm1d`](torch.nn.BatchNorm1d.html#torch.nn.BatchNorm1d "torch.nn.BatchNorm1d")  that is inferred
...
cls_to_become [source](https://github.com/pytorch/pytorch/blob/v2.8.0/torch/nn/modules/batchnorm.py#L268) 
:   alias of [`BatchNorm1d`](torch.nn.BatchNorm1d.html#torch.nn.BatchNorm1d "torch.nn.modules.batchnorm.BatchNorm1d")
