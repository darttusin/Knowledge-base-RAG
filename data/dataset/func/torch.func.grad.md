...
torch.func. grad ( *func*  , *argnums = 0*  , *has_aux = False* ) [source](https://github.com/pytorch/pytorch/blob/v2.8.0/torch/_functorch/apis.py#L298) 
...
* **argnums** ( [*int*](https://docs.python.org/3/library/functions.html#int "(in Python v3.13)") *or* *Tuple* *[* [*int*](https://docs.python.org/3/library/functions.html#int "(in Python v3.13)") *]*  ) – Specifies arguments to compute gradients with respect to. `argnums`  can be single integer or tuple of integers. Default: 0.
* **has_aux** ( [*bool*](https://docs.python.org/3/library/functions.html#bool "(in Python v3.13)")  ) – Flag indicating that `func`  returns a tensor and other
