...
* A nested graph break results in <!-- MathML: <math xmlns="http://www.w3.org/1998/Math/MathML">
<semantics>
<mrow>
...
</math> -->O ( N ) mathcal O(N)O ( N )  duplicate graph break behavior
...
Recall that in `fullgraph=False`  , [graph breaks are handled](programming_model.dynamo_core_concepts.html#programming-model-dynamo-core-concepts-graph-breaks)  by compiling the FX graph that has been determined so far,
...
Note that the runtime of handling this graph break is <!-- MathML: <math xmlns="http://www.w3.org/1998/Math/MathML">
<semantics>
<mrow>
<mi mathvariant="script">
          O
...
</math> -->O ( N K ) mathcal O(NK)O ( N K )  , where <!-- MathML: <math xmlns="http://www.w3.org/1998/Math/MathML">
<semantics>
<mrow>
<mi>
          N
...
</math> -->N NN  is the nesting depth,
...
</math> -->K KK  is the number of instructions from the top-level function to the graph break.
We end up tracing <!-- MathML: <math xmlns="http://www.w3.org/1998/Math/MathML">
<semantics>
<mrow>
<mi mathvariant="script">
          O
...
</math> -->O ( N 2 ) mathcal O(N^2)O ( N 2 )  frames, and we trace the same graph break <!-- MathML: <math xmlns="http://www.w3.org/1998/Math/MathML">
<semantics>
<mrow>
<mi mathvariant="script">
          O
...
</math> -->O ( N ) mathcal O(N)O ( N )  times.
