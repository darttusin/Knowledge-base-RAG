...
torch.autograd.functional. vhp ( *func*  , *inputs*  , *v = None*  , *create_graph = False*  , *strict = False* ) [source](https://github.com/pytorch/pytorch/blob/v2.8.0/torch/autograd/functional.py#L979) 
...
* **v** ( [*tuple*](https://docs.python.org/3/library/stdtypes.html#tuple "(in Python v3.13)") *of* *Tensors* *or* [*Tensor*](../tensors.html#torch.Tensor "torch.Tensor")  ) – The vector for which the vector Hessian
