* [TorchScript Language Reference](#torchscript-language-reference)
...
[TorchScript Language Reference](#id8) 
========================================================================================================

TorchScript is a statically typed subset of Python that can either be written directly (using
the [`@torch.jit.script`](generated/torch.jit.script.html#torch.jit.script "torch.jit.script")  decorator) or generated automatically from Python code via
...
| `NamedTuple[T0, T1, ...]` | A [`collections.namedtuple`](https://docs.python.org/3/library/collections.html#collections.namedtuple "(in Python v3.13)")  tuple type |
...
TorchScript does not support all features and types of the [`typing`](https://docs.python.org/3/library/typing.html#module-typing "(in Python v3.13)")  module. Some of these
...
These types and features from the [`typing`](https://docs.python.org/3/library/typing.html#module-typing "(in Python v3.13)")  module are unavailable in TorchScript. 

| Item | Description |
| --- | --- |
| [`typing.Any`](https://docs.python.org/3/library/typing.html#typing.Any "(in Python v3.13)") | [`typing.Any`](https://docs.python.org/3/library/typing.html#typing.Any "(in Python v3.13)")  is currently in development but not yet released |
| [`typing.NoReturn`](https://docs.python.org/3/library/typing.html#typing.NoReturn "(in Python v3.13)") | Not implemented |
| [`typing.Sequence`](https://docs.python.org/3/library/typing.html#typing.Sequence "(in Python v3.13)") | Not implemented |
| [`typing.Callable`](https://docs.python.org/3/library/typing.html#typing.Callable "(in Python v3.13)") | Not implemented |
| [`typing.Literal`](https://docs.python.org/3/library/typing.html#typing.Literal "(in Python v3.13)") | Not implemented |
| [`typing.ClassVar`](https://docs.python.org/3/library/typing.html#typing.ClassVar "(in Python v3.13)") | Not implemented |
| [`typing.Final`](https://docs.python.org/3/library/typing.html#typing.Final "(in Python v3.13)") | This is supported for [module attributes](#id6)  class attribute annotations but not for functions |
| [`typing.AnyStr`](https://docs.python.org/3/library/typing.html#typing.AnyStr "(in Python v3.13)") | TorchScript does not support [`bytes`](https://docs.python.org/3/library/stdtypes.html#bytes "(in Python v3.13)")  so this type is not used |
| [`typing.overload`](https://docs.python.org/3/library/typing.html#typing.overload "(in Python v3.13)") | [`typing.overload`](https://docs.python.org/3/library/typing.html#typing.overload "(in Python v3.13)")  is currently in development but not yet released |
...
Any other functionality from the [`typing`](https://docs.python.org/3/library/typing.html#module-typing "(in Python v3.13)")  module not explicitly listed in this documentation is unsupported.
...
An empty list is assumed to be `List[Tensor]`  and empty dicts `Dict[str, Tensor]`  . To instantiate an empty list or dict of other types,
...
The compiler can reason about multiple `None`  checks that are combined with `and`  , `or`  , and `not`  . Refinement will also occur for else blocks of if-statements
...
Python classes can be used in TorchScript if they are annotated with [`@torch.jit.script`](generated/torch.jit.script.html#torch.jit.script "torch.jit.script")  ,
...
like any other TorchScript type. The type of the values of an enum must be `int`  , `float`  , or `str`  . All values must be of the same type; heterogeneous types for enum
values are not supported.

### Named Tuples 

Types produced by [`collections.namedtuple`](https://docs.python.org/3/library/collections.html#collections.namedtuple "(in Python v3.13)")  can be used in TorchScript. 
...
Some functions (for example, [`zip`](https://docs.python.org/3/library/functions.html#zip "(in Python v3.13)")  and [`enumerate`](https://docs.python.org/3/library/functions.html#enumerate "(in Python v3.13)")  ) can only operate on iterable types.
Iterable types in TorchScript include `Tensor`  s, lists, tuples, dictionaries, strings, [`torch.nn.ModuleList`](generated/torch.nn.ModuleList.html#torch.nn.ModuleList "torch.nn.ModuleList")  and [`torch.nn.ModuleDict`](generated/torch.nn.ModuleDict.html#torch.nn.ModuleDict "torch.nn.ModuleDict")  .
...
a method other than `forward`  , use the [`@torch.jit.export`](jit.html#torch.jit.export "torch.jit.export")  decorator
...
constant by adding the name of the attribute to the `__constants__`  list for the type. For loops over a `nn.ModuleList`  will unroll the body of the
...
reference to `torch`  , the TorchScript compiler is actually resolving it to the `torch`  Python module when the function is declared. These Python values are
...
torch.jit. is_scripting ( ) [source](https://github.com/pytorch/pytorch/blob/v2.8.0/torch/_jit_internal.py#L106) 
...
torch.jit. is_tracing ( ) [source](https://github.com/pytorch/pytorch/blob/v2.8.0/torch/jit/_trace.py#L1327) 
...
TorchScript can lookup attributes on modules. `Builtin functions`  like `torch.add`  are accessed this way. This allows TorchScript to call functions defined in
other modules.
...
semantically the same as buffers. The type of empty lists and dictionaries and `None`  values cannot be inferred and must be specified via [PEP 526-style](https://www.python.org/dev/peps/pep-0526/#class-and-instance-variable-annotations)  class annotations.
