...
*class* torch.nn. LazyInstanceNorm1d ( *eps = 1e-05*  , *momentum = 0.1*  , *affine = True*  , *track_running_stats = True*  , *device = None*  , *dtype = None* ) [source](https://github.com/pytorch/pytorch/blob/v2.8.0/torch/nn/modules/instancenorm.py#L204) 
:   A [`torch.nn.InstanceNorm1d`](torch.nn.InstanceNorm1d.html#torch.nn.InstanceNorm1d "torch.nn.InstanceNorm1d")  module with lazy initialization of the `num_features`  argument. 

The `num_features`  argument of the [`InstanceNorm1d`](torch.nn.InstanceNorm1d.html#torch.nn.InstanceNorm1d "torch.nn.InstanceNorm1d")  is inferred from the `input.size(1)`  .
...
cls_to_become [source](https://github.com/pytorch/pytorch/blob/v2.8.0/torch/nn/modules/instancenorm.py#L127) 
:   alias of [`InstanceNorm1d`](torch.nn.InstanceNorm1d.html#torch.nn.InstanceNorm1d "torch.nn.modules.instancenorm.InstanceNorm1d")
