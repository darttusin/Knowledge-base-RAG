...
*class* torch.jit. ScriptModule [source](https://github.com/pytorch/pytorch/blob/v2.8.0/torch/jit/_script.py#L513) 
...
See [Inspecting Code](../jit.html#inspecting-code)  for details.
...
Implement this and a corresponding [`set_extra_state()`](#torch.jit.ScriptModule.set_extra_state "torch.jit.ScriptModule.set_extra_state")  for your module
...
See [Interpreting Graphs](../jit.html#interpreting-graphs)  for details.
...
:   Copy parameters and buffers from [`state_dict`](#torch.jit.ScriptModule.state_dict "torch.jit.ScriptModule.state_dict")  into this module and its descendants. 

If `strict`  is `True`  , then
the keys of [`state_dict`](#torch.jit.ScriptModule.state_dict "torch.jit.ScriptModule.state_dict")  must exactly match the keys returned
...
the call to [`load_state_dict`](#torch.jit.ScriptModule.load_state_dict "torch.jit.ScriptModule.load_state_dict")  unless [`get_swap_module_params_on_conversion()`](../future_mod.html#torch.__future__.get_swap_module_params_on_conversion "torch.__future__.get_swap_module_params_on_conversion")  is `True`  .
...
in [`state_dict`](#torch.jit.ScriptModule.state_dict "torch.jit.ScriptModule.state_dict")  match the keys returned by this module’s [`state_dict()`](torch.nn.Module.html#torch.nn.Module.state_dict "torch.nn.Module.state_dict")  function. Default: `True`
...
exists in [`state_dict`](#torch.jit.ScriptModule.state_dict "torch.jit.ScriptModule.state_dict")  , [`load_state_dict()`](#torch.jit.ScriptModule.load_state_dict "torch.jit.ScriptModule.load_state_dict")  will raise a `RuntimeError`  .
...
is that the latter will not be a part of this module’s [`state_dict`](#torch.jit.ScriptModule.state_dict "torch.jit.ScriptModule.state_dict")  . 
...
that run on buffers, such as [`cuda`](#torch.jit.ScriptModule.cuda "torch.jit.ScriptModule.cuda")  , are ignored. If `None`  ,
the buffer is **not** included in the module’s [`state_dict`](#torch.jit.ScriptModule.state_dict "torch.jit.ScriptModule.state_dict")  .
* **persistent** ( [*bool*](https://docs.python.org/3/library/functions.html#bool "(in Python v3.13)")  ) – whether the buffer is part of this module’s [`state_dict`](#torch.jit.ScriptModule.state_dict "torch.jit.ScriptModule.state_dict")  .
...
Note that the checks performed when calling [`load_state_dict()`](#torch.jit.ScriptModule.load_state_dict "torch.jit.ScriptModule.load_state_dict")  with `strict=True`  are affected by modifications the hook makes to `missing_keys`  or `unexpected_keys`  , as expected. Additions to either
...
:   Alias for [`add_module()`](#torch.jit.ScriptModule.add_module "torch.jit.ScriptModule.add_module")  .
...
from this module using the given name
* **param** ( [*Parameter*](torch.nn.parameter.Parameter.html#torch.nn.parameter.Parameter "torch.nn.parameter.Parameter") *or* *None*  ) – parameter to be added to the module. If `None`  , then operations that run on parameters, such as [`cuda`](#torch.jit.ScriptModule.cuda "torch.jit.ScriptModule.cuda")  ,
are ignored. If `None`  , the parameter is **not** included in the
module’s [`state_dict`](#torch.jit.ScriptModule.state_dict "torch.jit.ScriptModule.state_dict")  .
...
save ( *f*  , *** kwargs* ) [source](https://github.com/pytorch/pytorch/blob/v2.8.0/torch/jit/_script.py#L748) 
:   Save with a file-like object. 

save(f, _extra_files={}) 

See [`torch.jit.save`](torch.jit.save.html#torch.jit.save "torch.jit.save")  which accepts a file-like object.
...
This function is called from [`load_state_dict()`](#torch.jit.ScriptModule.load_state_dict "torch.jit.ScriptModule.load_state_dict")  to handle any extra state
found within the *state_dict* . Implement this function and a corresponding [`get_extra_state()`](#torch.jit.ScriptModule.get_extra_state "torch.jit.ScriptModule.get_extra_state")  for your module if you need to store extra state within its *state_dict* . 
