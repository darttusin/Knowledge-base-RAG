...
*class* torch.nn. BatchNorm3d ( *num_features*  , *eps = 1e-05*  , *momentum = 0.1*  , *affine = True*  , *track_running_stats = True*  , *device = None*  , *dtype = None* ) [source](https://github.com/pytorch/pytorch/blob/v2.8.0/torch/nn/modules/batchnorm.py#L489) 
:   Applies Batch Normalization over a 5D input. 

5D is a mini-batch of 3D inputs with additional channel dimension as described in the paper [Batch Normalization: Accelerating Deep Network Training by Reducing
...
the mini-batches and <!-- MathML: <math xmlns="http://www.w3.org/1998/Math/MathML">
<semantics>
<mrow>
<mi>
            γ
...
of size *C* (where *C* is the input size). By default, the elements of <!-- MathML: <math xmlns="http://www.w3.org/1998/Math/MathML">
<semantics>
<mrow>
<mi>
            γ
...
</math> -->γ gammaγ  are set
to 1 and the elements of <!-- MathML: <math xmlns="http://www.w3.org/1998/Math/MathML">
<semantics>
<mrow>
<mi>
            β
...
</math> -->β betaβ  are set to 0. At train time in the forward pass, the
...
standard-deviation is calculated via the unbiased estimator, equivalent to `torch.var(input, unbiased=True)`  . 
...
</math> -->( N , C , D , H , W ) (N, C, D, H, W)( N , C , D , H , W )  (same shape as input)
