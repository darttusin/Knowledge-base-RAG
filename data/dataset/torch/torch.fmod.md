...
torch. fmod ( *input*  , *other*  , *** , *out = None* ) → [Tensor](../tensors.html#torch.Tensor "torch.Tensor") 
...
This function may be defined in terms of [`torch.div()`](torch.div.html#torch.div "torch.div")  as 
...
[`torch.remainder()`](torch.remainder.html#torch.remainder "torch.remainder")  which implements Python’s modulus operator.
