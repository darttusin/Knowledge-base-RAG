...
*class* torch.nn. UpsamplingNearest2d ( *size = None*  , *scale_factor = None* ) [source](https://github.com/pytorch/pytorch/blob/v2.8.0/torch/nn/modules/upsampling.py#L196) 
