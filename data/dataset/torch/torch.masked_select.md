...
torch. masked_select ( *input*  , *mask*  , *** , *out = None* ) → [Tensor](../tensors.html#torch.Tensor "torch.Tensor") 
...
to match, but they must be [broadcastable](../notes/broadcasting.html#broadcasting-semantics)  . 
