...
expression is a class instance attribute with type of *type* . Note that *torch.jit.Attribute* should only be used in *__init__* method of *jit.ScriptModule* subclasses. 
