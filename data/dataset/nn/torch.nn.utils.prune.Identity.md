...
*class* torch.nn.utils.prune. Identity [source](https://github.com/pytorch/pytorch/blob/v2.8.0/torch/nn/utils/prune.py#L410) 
:   Utility pruning method that does not prune any units but generates the pruning parametrization with a mask of ones. 

*classmethod* apply ( *module*  , *name* ) [source](https://github.com/pytorch/pytorch/blob/v2.8.0/torch/nn/utils/prune.py#L419) 
