...
torch.nn.functional. multilabel_soft_margin_loss ( *input*  , *target*  , *weight = None*  , *size_average = None*  , *reduce = None*  , *reduction = 'mean'* ) [source](https://github.com/pytorch/pytorch/blob/v2.8.0/torch/nn/functional.py#L4071) 
:   Compute the multilabel soft margin loss. 

See [`MultiLabelSoftMarginLoss`](torch.nn.MultiLabelSoftMarginLoss.html#torch.nn.MultiLabelSoftMarginLoss "torch.nn.MultiLabelSoftMarginLoss")  for details. 
