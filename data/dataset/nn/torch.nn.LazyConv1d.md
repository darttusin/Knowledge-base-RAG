...
*class* torch.nn. LazyConv1d ( *out_channels*  , *kernel_size*  , *stride = 1*  , *padding = 0*  , *dilation = 1*  , *groups = 1*  , *bias = True*  , *padding_mode = 'zeros'*  , *device = None*  , *dtype = None* ) [source](https://github.com/pytorch/pytorch/blob/v2.8.0/torch/nn/modules/conv.py#L1452) 
:   A [`torch.nn.Conv1d`](torch.nn.Conv1d.html#torch.nn.Conv1d "torch.nn.Conv1d")  module with lazy initialization of the `in_channels`  argument. 

The `in_channels`  argument of the [`Conv1d`](torch.nn.Conv1d.html#torch.nn.Conv1d "torch.nn.Conv1d")  is inferred from the `input.size(1)`  .
...
[`torch.nn.Conv1d`](torch.nn.Conv1d.html#torch.nn.Conv1d "torch.nn.Conv1d")  and [`torch.nn.modules.lazy.LazyModuleMixin`](torch.nn.modules.lazy.LazyModuleMixin.html#torch.nn.modules.lazy.LazyModuleMixin "torch.nn.modules.lazy.LazyModuleMixin")

cls_to_become [source](https://github.com/pytorch/pytorch/blob/v2.8.0/torch/nn/modules/conv.py#L212) 
:   alias of [`Conv1d`](torch.nn.Conv1d.html#torch.nn.Conv1d "torch.nn.modules.conv.Conv1d")
