...
*class* torch.nn. LazyInstanceNorm3d ( *eps = 1e-05*  , *momentum = 0.1*  , *affine = True*  , *track_running_stats = True*  , *device = None*  , *dtype = None* ) [source](https://github.com/pytorch/pytorch/blob/v2.8.0/torch/nn/modules/instancenorm.py#L436) 
:   A [`torch.nn.InstanceNorm3d`](torch.nn.InstanceNorm3d.html#torch.nn.InstanceNorm3d "torch.nn.InstanceNorm3d")  module with lazy initialization of the `num_features`  argument. 

The `num_features`  argument of the [`InstanceNorm3d`](torch.nn.InstanceNorm3d.html#torch.nn.InstanceNorm3d "torch.nn.InstanceNorm3d")  is inferred from the `input.size(1)`  .
...
cls_to_become [source](https://github.com/pytorch/pytorch/blob/v2.8.0/torch/nn/modules/instancenorm.py#L358) 
:   alias of [`InstanceNorm3d`](torch.nn.InstanceNorm3d.html#torch.nn.InstanceNorm3d "torch.nn.modules.instancenorm.InstanceNorm3d")
