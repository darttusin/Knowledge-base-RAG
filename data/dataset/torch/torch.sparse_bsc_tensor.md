...
torch. sparse_bsc_tensor ( *ccol_indices*  , *row_indices*  , *values*  , *size = None*  , *** , *dtype = None*  , *device = None*  , *pin_memory = False*  , *requires_grad = False*  , *check_invariants = None* ) → [Tensor](../tensors.html#torch.Tensor "torch.Tensor") 
:   Constructs a [sparse tensor in BSC (Block Compressed Sparse
Column))](../sparse.html#sparse-bsc-docs)  with specified 2-dimensional blocks at the
...
note on the data type of the indices](../sparse.html#sparse-bsc-docs)  . 
...
Parameters
:   * **ccol_indices** ( *array_like*  ) – (B+1)-dimensional array of size `(*batchsize, ncolblocks + 1)`  . The last element of each
...
sparse tensor: `(*batchsize, nrows * blocksize[0], ncols * blocksize[1], *densesize)`  If not provided, the size will be
