...
* [Supported Tensor Methods](#supported-tensor-methods)
* [Supported PyTorch Functions](#supported-pytorch-functions)
* [TorchScript Builtin Functions](#torchscript-builtin-functions)
* [Python Built-in Functions](#python-built-in-functions)
* [`math` Module](#math-module)

[Supported Tensor Methods](#id5) 
--------------------------------------------------------------------------------------------
...
[Supported PyTorch Functions](#id6) 
--------------------------------------------------------------------------------------------------
...
[TorchScript Builtin Functions](#id7) 
------------------------------------------------------------------------------------------------------
...
| Function | Note |
| --- | --- |
| [`print`](https://docs.python.org/3/library/functions.html#print "(in Python v3.13)") | Print any value |
| [`tuple`](https://docs.python.org/3/library/stdtypes.html#tuple "(in Python v3.13)") | Lists cannot be converted to tuples with this method since their size is not statically known |
| [`getattr`](https://docs.python.org/3/library/functions.html#getattr "(in Python v3.13)") | Attribute name must be a literal string |
| [`hasattr`](https://docs.python.org/3/library/functions.html#hasattr "(in Python v3.13)") | Attribute name must be a literal string |
| [`isinstance`](https://docs.python.org/3/library/functions.html#isinstance "(in Python v3.13)") | Result is static |
| [`range`](https://docs.python.org/3/library/stdtypes.html#range "(in Python v3.13)") | Can only be used as an iterator in a for loop |
| [`zip`](https://docs.python.org/3/library/functions.html#zip "(in Python v3.13)") | Arguments must be iterable. See [Iterables](jit_language_reference.html#jit-iterables)  for details. |
| [`enumerate`](https://docs.python.org/3/library/functions.html#enumerate "(in Python v3.13)") | Arguments must be iterable. See [Iterables](jit_language_reference.html#jit-iterables)  for details. |

The following functions will use the corresponding magic method on [TorchScript Classes](jit_language_reference.html#torchscript-classes) 
