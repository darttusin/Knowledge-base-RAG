...
should be sufficient for most use-cases (see [torchrun (Elastic Launch)](run.html#launcher-api)  ).
...
Please refer to [Rendezvous](rendezvous.html#rendezvous-api)  for more information.
...
TorchElastic supports events recording (see [Events](events.html#events-api)  ).
...
events. To configure custom events handler you need to implement *torch.distributed.elastic.events.EventHandler* interface and *configure* it
