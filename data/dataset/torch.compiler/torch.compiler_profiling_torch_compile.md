...
![Example of a basic chrome trace, visualized in the chrome://tracing viewer](_images/basic_chrome_trace.png)
...
![Visualization in the chrome://trace viewer, showing an async flow between a kernel and its launching location.](_images/ac2g.png)
...
![A visualization in the chrome://trace viewer, showing dynamo and inductor compilation steps](_images/compilation_profiling.png)
...
![Visualization in the chrome://trace viewer, showing nested Torch-Compiled Region events and multiple CompiledFunction events - indicating graph breaks.](_images/graph_breaks_with_torch_compiled_region.png)
...
![Visualization in the chrome://trace viewer, showing the three types of events - CPU-side event, kernel launch, and GPU-side event](_images/kernel_launch_labeled.png)
...
![_images/triton_kernel_launch.png](_images/triton_kernel_launch.png)
...
![_images/noninductor_triton_kernel.png](_images/noninductor_triton_kernel.png)
...
![Visualization in the chrome://trace viewer, showing large gaps between GPU kernels. This indicates that the model is CPU bound, likely due to overhead during kernel launches.](_images/cpu_bound.png)
