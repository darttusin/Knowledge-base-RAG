...
*class* torch.nn. L1Loss ( *size_average = None*  , *reduce = None*  , *reduction = 'mean'* ) [source](https://github.com/pytorch/pytorch/blob/v2.8.0/torch/nn/modules/loss.py#L62) 
:   Creates a criterion that measures the mean absolute error (MAE) between each element in
the input <!-- MathML: <math xmlns="http://www.w3.org/1998/Math/MathML">
<semantics>
<mrow>
<mi>
            x
...
ℓ ( x , y ) = L = { l 1 , … , l N } ⊤ , l n = ∣ x n − y n ∣ , ell(x, y) = L = {l_1,dots,l_N}^top, quad
l_n = left| x_n - y_n right|,

ℓ ( x , y ) = L = { l 1 ​ , … , l N ​ } ⊤ , l n ​ = ∣ x n ​ − y n ​ ∣ ,
...
The sum operation still operates over all the elements, and divides by <!-- MathML: <math xmlns="http://www.w3.org/1998/Math/MathML">
<semantics>
<mrow>
<mi>
            N
