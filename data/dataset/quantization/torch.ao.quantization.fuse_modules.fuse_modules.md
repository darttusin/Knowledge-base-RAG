...
*class* torch.ao.quantization.fuse_modules. fuse_modules ( *model*  , *modules_to_fuse*  , *inplace=False*  , *fuser_func=<function fuse_known_modules>*  , *fuse_custom_config_dict=None* ) [source](https://github.com/pytorch/pytorch/blob/v2.8.0/torch/ao/quantization/fuse_modules.py#L130) 
