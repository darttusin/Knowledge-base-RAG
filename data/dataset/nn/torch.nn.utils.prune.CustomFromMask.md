...
*class* torch.nn.utils.prune. CustomFromMask ( *mask* ) [source](https://github.com/pytorch/pytorch/blob/v2.8.0/torch/nn/utils/prune.py#L796) 
:   *classmethod* apply ( *module*  , *name*  , *mask* ) [source](https://github.com/pytorch/pytorch/blob/v2.8.0/torch/nn/utils/prune.py#L807) 
