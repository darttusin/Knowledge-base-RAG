...
torch.signal.windows. kaiser ( *M*  , *** , *beta = 12.0*  , *sym = True*  , *dtype = None*  , *layout = torch.strided*  , *device = None*  , *requires_grad = False* ) [source](https://github.com/pytorch/pytorch/blob/v2.8.0/torch/signal/windows/windows.py#L334) 
...
Keyword Arguments
:   * **beta** ( [*float*](https://docs.python.org/3/library/functions.html#float "(in Python v3.13)") *,* *optional*  ) – shape parameter for the window. Must be non-negative. Default: 12.0
