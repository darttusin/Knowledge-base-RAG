...
By adding the following configuration metrics, `torchelastic`  and `my_app`  metric groups will be printed out to
console. 
...
*class* torch.distributed.elastic.metrics.api. MetricHandler [source](https://github.com/pytorch/pytorch/blob/v2.8.0/torch/distributed/elastic/metrics/api.py#L46) 
:

*class* torch.distributed.elastic.metrics.api. ConsoleMetricHandler [source](https://github.com/pytorch/pytorch/blob/v2.8.0/torch/distributed/elastic/metrics/api.py#L52) 
:

*class* torch.distributed.elastic.metrics.api. NullMetricHandler [source](https://github.com/pytorch/pytorch/blob/v2.8.0/torch/distributed/elastic/metrics/api.py#L59) 
:

Methods 
--------------------------------------------------

torch.distributed.elastic.metrics. configure ( *handler*  , *group = None* ) [source](https://github.com/pytorch/pytorch/blob/v2.8.0/torch/distributed/elastic/metrics/api.py#L80) 
:

torch.distributed.elastic.metrics. prof ( *fn = None*  , *group = 'torchelastic'* ) [source](https://github.com/pytorch/pytorch/blob/v2.8.0/torch/distributed/elastic/metrics/api.py#L111) 
...
torch.distributed.elastic.metrics. put_metric ( *metric_name*  , *metric_value*  , *metric_group = 'torchelastic'* ) [source](https://github.com/pytorch/pytorch/blob/v2.8.0/torch/distributed/elastic/metrics/api.py#L191) 
