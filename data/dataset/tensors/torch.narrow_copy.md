...
torch. narrow_copy ( *input*  , *dim*  , *start*  , *length*  , *** , *out = None* ) → [Tensor](../tensors.html#torch.Tensor "torch.Tensor") 
:   Same as [`Tensor.narrow()`](torch.Tensor.narrow.html#torch.Tensor.narrow "torch.Tensor.narrow")  except this returns a copy rather
...
* **start** ( [*int*](https://docs.python.org/3/library/functions.html#int "(in Python v3.13)")  ) – index of the element to start the narrowed dimension from. Can
...
[`torch.narrow()`](torch.narrow.html#torch.narrow "torch.narrow")  for a non copy variant
