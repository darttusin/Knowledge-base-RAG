...
torch.nn.functional. dropout1d ( *input*  , *p = 0.5*  , *training = True*  , *inplace = False* ) [source](https://github.com/pytorch/pytorch/blob/v2.8.0/torch/nn/functional.py#L1449) 
...
batched input is a 1D tensor <!-- MathML: <math xmlns="http://www.w3.org/1998/Math/MathML">
<semantics>
<mrow>
<mtext>
            input
...
See [`Dropout1d`](torch.nn.Dropout1d.html#torch.nn.Dropout1d "torch.nn.Dropout1d")  for details. 
