...
*class* torch.nn. LazyConvTranspose3d ( *out_channels*  , *kernel_size*  , *stride = 1*  , *padding = 0*  , *output_padding = 0*  , *groups = 1*  , *bias = True*  , *dilation = 1*  , *padding_mode = 'zeros'*  , *device = None*  , *dtype = None* ) [source](https://github.com/pytorch/pytorch/blob/v2.8.0/torch/nn/modules/conv.py#L1798) 
:   A [`torch.nn.ConvTranspose3d`](torch.nn.ConvTranspose3d.html#torch.nn.ConvTranspose3d "torch.nn.ConvTranspose3d")  module with lazy initialization of the `in_channels`  argument. 

The `in_channels`  argument of the [`ConvTranspose3d`](torch.nn.ConvTranspose3d.html#torch.nn.ConvTranspose3d "torch.nn.ConvTranspose3d")  is inferred from
the `input.size(1)`  .
...
[`torch.nn.ConvTranspose3d`](torch.nn.ConvTranspose3d.html#torch.nn.ConvTranspose3d "torch.nn.ConvTranspose3d")  and [`torch.nn.modules.lazy.LazyModuleMixin`](torch.nn.modules.lazy.LazyModuleMixin.html#torch.nn.modules.lazy.LazyModuleMixin "torch.nn.modules.lazy.LazyModuleMixin")

cls_to_become [source](https://github.com/pytorch/pytorch/blob/v2.8.0/torch/nn/modules/conv.py#L1173) 
:   alias of [`ConvTranspose3d`](torch.nn.ConvTranspose3d.html#torch.nn.ConvTranspose3d "torch.nn.modules.conv.ConvTranspose3d")
