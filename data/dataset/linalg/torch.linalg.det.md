...
torch.linalg. det ( *A*  , *** , *out = None* ) → [Tensor](../tensors.html#torch.Tensor "torch.Tensor") 
...
[`torch.linalg.slogdet()`](torch.linalg.slogdet.html#torch.linalg.slogdet "torch.linalg.slogdet")  computes the sign and natural logarithm of the absolute
