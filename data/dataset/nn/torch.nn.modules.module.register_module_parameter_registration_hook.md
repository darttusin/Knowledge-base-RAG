...
torch.nn.modules.module. register_module_parameter_registration_hook ( *hook* ) [source](https://github.com/pytorch/pytorch/blob/v2.8.0/torch/nn/modules/module.py#L188) 
