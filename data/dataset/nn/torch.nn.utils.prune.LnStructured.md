...
*class* torch.nn.utils.prune. LnStructured ( *amount*  , *n*  , *dim = -1* ) [source](https://github.com/pytorch/pytorch/blob/v2.8.0/torch/nn/utils/prune.py#L666) 
:   Prune entire (currently unpruned) channels in a tensor based on their L `n`  -norm. 

Parameters
:   * **amount** ( [*int*](https://docs.python.org/3/library/functions.html#int "(in Python v3.13)") *or* [*float*](https://docs.python.org/3/library/functions.html#float "(in Python v3.13)")  ) – quantity of channels to prune.
...
*classmethod* apply ( *module*  , *name*  , *amount*  , *n*  , *dim*  , *importance_scores = None* ) [source](https://github.com/pytorch/pytorch/blob/v2.8.0/torch/nn/utils/prune.py#L760) 
...
* **n** ( [*int*](https://docs.python.org/3/library/functions.html#int "(in Python v3.13)") *,* [*float*](https://docs.python.org/3/library/functions.html#float "(in Python v3.13)") *,* *inf* *,* *-inf* *,* *'fro'* *,* *'nuc'*  ) – See documentation of valid
entries for argument `p`  in [`torch.norm()`](torch.norm.html#torch.norm "torch.norm")  .
* **dim** ( [*int*](https://docs.python.org/3/library/functions.html#int "(in Python v3.13)")  ) – index of the dim along which we define channels to
prune.
...
compute_mask ( *t*  , *default_mask* ) [source](https://github.com/pytorch/pytorch/blob/v2.8.0/torch/nn/utils/prune.py#L689) 
...
According to the pruning rule specified in [`compute_mask()`](#torch.nn.utils.prune.LnStructured.compute_mask "torch.nn.utils.prune.LnStructured.compute_mask")  . 
