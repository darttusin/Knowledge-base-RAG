...
of [`torch.linalg.cholesky()`](torch.linalg.cholesky.html#torch.linalg.cholesky "torch.linalg.cholesky")  , instead directly returning the LAPACK
...
than [`torch.linalg.cholesky()`](torch.linalg.cholesky.html#torch.linalg.cholesky "torch.linalg.cholesky")  does. 
...
and the decomposition could not be completed. `info`  filled with zeros indicates that the decomposition was successful.
...
[`torch.linalg.cholesky()`](torch.linalg.cholesky.html#torch.linalg.cholesky "torch.linalg.cholesky")  is a NumPy compatible variant that always checks for errors.

Parameters
: **A** ( [*Tensor*](../tensors.html#torch.Tensor "torch.Tensor")  ) – the Hermitian *n times n* matrix or the batch of such matrices of size *(*, n, n)* where *** is one or more batch dimensions.
...
* **check_errors** ( [*bool*](https://docs.python.org/3/library/functions.html#bool "(in Python v3.13)") *,* *optional*  ) – controls whether to check the content of `infos`  . Default: *False* .
