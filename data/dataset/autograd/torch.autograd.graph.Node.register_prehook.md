...
*abstract* Node. register_prehook ( *fn* ) [source](https://github.com/pytorch/pytorch/blob/v2.8.0/torch/autograd/graph.py#L127) 
...
a new gradient which will be used in place of `grad_outputs`  . 
