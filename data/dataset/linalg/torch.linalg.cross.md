...
torch.linalg. cross ( *input*  , *other*  , *** , *dim = -1*  , *out = None* ) → [Tensor](../tensors.html#torch.Tensor "torch.Tensor") 
...
* **dim** ( [*int*](https://docs.python.org/3/library/functions.html#int "(in Python v3.13)") *,* *optional*  ) – the dimension along which to take the cross-product. Default: *-1* .
