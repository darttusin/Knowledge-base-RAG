...
torch.nn.functional. dropout3d ( *input*  , *p = 0.5*  , *training = True*  , *inplace = False* ) [source](https://github.com/pytorch/pytorch/blob/v2.8.0/torch/nn/functional.py#L1559) 
...
See [`Dropout3d`](torch.nn.Dropout3d.html#torch.nn.Dropout3d "torch.nn.Dropout3d")  for details. 
