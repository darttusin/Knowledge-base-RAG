...
*class* torch.optim.lr_scheduler. ExponentialLR ( *optimizer*  , *gamma*  , *last_epoch = -1* ) [source](https://github.com/pytorch/pytorch/blob/v2.8.0/torch/optim/lr_scheduler.py#L762) 
...
get_lr ( ) [source](https://github.com/pytorch/pytorch/blob/v2.8.0/torch/optim/lr_scheduler.py#L792) 
...
from a call to [`state_dict()`](#torch.optim.lr_scheduler.ExponentialLR.state_dict "torch.optim.lr_scheduler.ExponentialLR.state_dict")  .
