...
Read more about feature classification at: https://localhost:8000/blog/pytorch-feature-classification-changes/#prototype
...
torch._higher_order_ops.cond. cond ( *pred*  , *true_fn*  , *false_fn*  , *operands = ()* ) [source](https://github.com/pytorch/pytorch/blob/v2.8.0/torch/_higher_order_ops/cond.py#L62) 
