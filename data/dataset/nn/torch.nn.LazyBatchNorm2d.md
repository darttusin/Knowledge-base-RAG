...
*class* torch.nn. LazyBatchNorm2d ( *eps = 1e-05*  , *momentum = 0.1*  , *affine = True*  , *track_running_stats = True*  , *device = None*  , *dtype = None* ) [source](https://github.com/pytorch/pytorch/blob/v2.8.0/torch/nn/modules/batchnorm.py#L455) 
:   A [`torch.nn.BatchNorm2d`](torch.nn.BatchNorm2d.html#torch.nn.BatchNorm2d "torch.nn.BatchNorm2d")  module with lazy initialization. 

Lazy initialization is done for the `num_features`  argument of the [`BatchNorm2d`](torch.nn.BatchNorm2d.html#torch.nn.BatchNorm2d "torch.nn.BatchNorm2d")  that is inferred
...
cls_to_become [source](https://github.com/pytorch/pytorch/blob/v2.8.0/torch/nn/modules/batchnorm.py#L378) 
:   alias of [`BatchNorm2d`](torch.nn.BatchNorm2d.html#torch.nn.BatchNorm2d "torch.nn.modules.batchnorm.BatchNorm2d")
