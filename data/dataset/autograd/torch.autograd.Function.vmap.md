...
*static* Function. vmap ( *info*  , *in_dims*  , ** args* ) [source](https://github.com/pytorch/pytorch/blob/v2.8.0/torch/autograd/function.py#L527) 
...
* `*args`  , which is the same as the args to [`forward()`](torch.autograd.Function.forward.html#torch.autograd.Function.forward "torch.autograd.Function.forward")  .
