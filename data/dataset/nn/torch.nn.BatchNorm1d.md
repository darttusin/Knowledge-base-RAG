...
*class* torch.nn. BatchNorm1d ( *num_features*  , *eps = 1e-05*  , *momentum = 0.1*  , *affine = True*  , *track_running_stats = True*  , *device = None*  , *dtype = None* ) [source](https://github.com/pytorch/pytorch/blob/v2.8.0/torch/nn/modules/batchnorm.py#L268) 
...
elements of <!-- MathML: <math xmlns="http://www.w3.org/1998/Math/MathML">
<semantics>
<mrow>
<mi>
            γ
...
</math> -->γ gammaγ  are set to 1 and the elements of <!-- MathML: <math xmlns="http://www.w3.org/1998/Math/MathML">
<semantics>
<mrow>
<mi>
            β
...
moving average of the variance is calculated via the unbiased estimator, equivalent to `torch.var(input, unbiased=True)`  . 
...
</math> -->( N , C , L ) (N, C, L)( N , C , L )  , where <!-- MathML: <math xmlns="http://www.w3.org/1998/Math/MathML">
<semantics>
<mrow>
<mi>
                N
...
</math> -->C CC  is the number of features or channels, and <!-- MathML: <math xmlns="http://www.w3.org/1998/Math/MathML">
<semantics>
<mrow>
<mi>
                L
...
</math> -->L LL  is the sequence length
