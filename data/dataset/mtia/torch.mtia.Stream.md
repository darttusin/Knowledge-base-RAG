...
Return type
:   [Stream](#torch.mtia.Stream "torch.mtia.Stream")
...
record_event ( *event* ) → [Event](torch.mtia.Event.html#torch.mtia.Event "torch.mtia.Event") 
...
Return type
:   [Event](torch.mtia.Event.html#torch.mtia.Event "torch.mtia.Event")
...
Parameters
: **stream** ( [`torch.Stream`](torch.Stream.html#torch.Stream "torch.Stream")  ) – a stream to synchronize.
