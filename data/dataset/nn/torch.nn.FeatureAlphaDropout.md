...
*class* torch.nn. FeatureAlphaDropout ( *p = 0.5*  , *inplace = False* ) [source](https://github.com/pytorch/pytorch/blob/v2.8.0/torch/nn/modules/dropout.py#L257) 
...
Parameters
:   * **p** ( [*float*](https://docs.python.org/3/library/functions.html#float "(in Python v3.13)") *,* *optional*  ) – probability of an element to be zeroed. Default: 0.5
