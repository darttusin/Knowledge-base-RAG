...
torch. sparse_csr_tensor ( *crow_indices*  , *col_indices*  , *values*  , *size = None*  , *** , *dtype = None*  , *device = None*  , *pin_memory = False*  , *requires_grad = False*  , *check_invariants = None* ) → [Tensor](../tensors.html#torch.Tensor "torch.Tensor") 
:   Constructs a [sparse tensor in CSR (Compressed Sparse Row)](../sparse.html#sparse-csr-docs)  with specified
...
at [the note on the data type of the indices](../sparse.html#sparse-csr-docs)  . 
...
Parameters
:   * **crow_indices** ( *array_like*  ) – (B+1)-dimensional array of size `(*batchsize, nrows + 1)`  . The last element of each batch
