...
torch. ne ( *input*  , *other*  , *** , *out = None* ) → [Tensor](../tensors.html#torch.Tensor "torch.Tensor") 
...
<annotation encoding="application/x-tex">
           text{input} neq text{other}
          </annotation>
</semantics>
</math> -->input ≠ other text{input} neq text{other}input  = other  element-wise. 
