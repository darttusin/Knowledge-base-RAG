...
Tensor. to_sparse_csr ( *dense_dim = None* ) → [Tensor](../tensors.html#torch.Tensor "torch.Tensor") 
...
resulting CSR tensor. This argument should be used only if `self`  is a strided tensor, and must be a value between 0
