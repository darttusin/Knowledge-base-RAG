...
torch.nn.utils.prune. global_unstructured ( *parameters*  , *pruning_method*  , *importance_scores = None*  , *** kwargs* ) [source](https://github.com/pytorch/pytorch/blob/v2.8.0/torch/nn/utils/prune.py#L1025) 
...
* **importance_scores** ( [*dict*](https://docs.python.org/3/library/stdtypes.html#dict "(in Python v3.13)")  ) – a dictionary mapping (module, name) tuples to
...
Raises
:   [**TypeError**](https://docs.python.org/3/library/exceptions.html#TypeError "(in Python v3.13)")  – if `PRUNING_TYPE != 'unstructured'`
