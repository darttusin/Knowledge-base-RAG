...
It can be enabled either by importing this module and calling [`enable_cuda_sanitizer()`](#torch.cuda._sanitizer.enable_cuda_sanitizer "torch.cuda._sanitizer.enable_cuda_sanitizer")  or by exporting the `TORCH_CUDA_SANITIZER`  environment variable.
...
The list of supported torch operators and their schemas can be viewed [here](torch.html)  .
...
torch.cuda._sanitizer. enable_cuda_sanitizer ( ) [source](https://github.com/pytorch/pytorch/blob/v2.8.0/torch/cuda/_sanitizer.py#L651) 
