...
torch.cuda.jiterator. _create_jit_fn ( *code_string*  , *** kwargs* ) [source](https://github.com/pytorch/pytorch/blob/v2.8.0/torch/cuda/jiterator.py#L98) 
...
Parameters
:   * **code_string** ( [*str*](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.13)")  ) – CUDA code string to be compiled by jiterator. The entry functor must return by value.
