...
*class* torch.nn.utils.prune. BasePruningMethod [source](https://github.com/pytorch/pytorch/blob/v2.8.0/torch/nn/utils/prune.py#L11) 
...
such as [`compute_mask()`](#torch.nn.utils.prune.BasePruningMethod.compute_mask "torch.nn.utils.prune.BasePruningMethod.compute_mask")  and [`apply()`](#torch.nn.utils.prune.BasePruningMethod.apply "torch.nn.utils.prune.BasePruningMethod.apply")  . 
...
*abstract* compute_mask ( *t*  , *default_mask* ) [source](https://github.com/pytorch/pytorch/blob/v2.8.0/torch/nn/utils/prune.py#L33) 
...
Parameters
:   * **t** ( [*torch.Tensor*](../tensors.html#torch.Tensor "torch.Tensor")  ) – tensor representing the importance scores of the
* **prune.** ( *parameter to*  ) –
...
According to the pruning rule specified in [`compute_mask()`](#torch.nn.utils.prune.BasePruningMethod.compute_mask "torch.nn.utils.prune.BasePruningMethod.compute_mask")  . 
