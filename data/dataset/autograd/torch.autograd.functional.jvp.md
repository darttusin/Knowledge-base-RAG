...
torch.autograd.functional. jvp ( *func*  , *inputs*  , *v = None*  , *create_graph = False*  , *strict = False* ) [source](https://github.com/pytorch/pytorch/blob/v2.8.0/torch/autograd/functional.py#L358) 
...
* **v** ( [*tuple*](https://docs.python.org/3/library/stdtypes.html#tuple "(in Python v3.13)") *of* *Tensors* *or* [*Tensor*](../tensors.html#torch.Tensor "torch.Tensor")  ) – The vector for which the Jacobian
...
the most performant way of computing the jvp. Please consider using [`torch.func.jvp()`](torch.func.jvp.html#torch.func.jvp "torch.func.jvp")  or the [low-level forward-mode AD API](../autograd.html#forward-mode-ad)  instead.
