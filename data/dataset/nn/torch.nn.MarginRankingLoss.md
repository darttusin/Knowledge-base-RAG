...
*class* torch.nn. MarginRankingLoss ( *margin = 0.0*  , *size_average = None*  , *reduce = None*  , *reduction = 'mean'* ) [source](https://github.com/pytorch/pytorch/blob/v2.8.0/torch/nn/modules/loss.py#L1447) 
:   Creates a criterion that measures the loss given
inputs <!-- MathML: <math xmlns="http://www.w3.org/1998/Math/MathML">
<semantics>
<mrow>
<mi>
            x
...
</math> -->x 2 x2x 2  , two 1D mini-batch or 0D *Tensors* ,
and a label 1D mini-batch or 0D *Tensor*<!-- MathML: <math xmlns="http://www.w3.org/1998/Math/MathML">
<semantics>
<mrow>
<mi>
            y
...
</math> -->y = 1 y = 1y = 1  then it assumed the first input should be ranked higher
(have a larger value) than the second input, and vice-versa for <!-- MathML: <math xmlns="http://www.w3.org/1998/Math/MathML">
<semantics>
<mrow>
<mi>
            y
...
<annotation encoding="application/x-tex">
           text{loss}(x1, x2, y) = max(0, -y * (x1 - x2) + text{margin})
          </annotation>
</semantics>
</math> -->
loss ( x 1 , x 2 , y ) = max ⁡ ( 0 , − y ∗ ( x 1 − x 2 ) + margin ) text{loss}(x1, x2, y) = max(0, -y * (x1 - x2) + text{margin})
...
</math> -->( ) ()( )  where *N* is the batch size.
...
</math> -->( ) ()( )  , same shape as the inputs.

* Output: scalar. If `reduction`  is `'none'`  and Input size is not <!-- MathML: <math xmlns="http://www.w3.org/1998/Math/MathML">
<semantics>
<mrow>
<mo stretchy="false">
                (
...
</math> -->( ) ()( )  , then <!-- MathML: <math xmlns="http://www.w3.org/1998/Math/MathML">
<semantics>
<mrow>
<mo stretchy="false">
                (
