...
torch.nn.functional. cosine_embedding_loss ( *input1*  , *input2*  , *target*  , *margin = 0*  , *size_average = None*  , *reduce = None*  , *reduction = 'mean'* ) [source](https://github.com/pytorch/pytorch/blob/v2.8.0/torch/nn/functional.py#L4131) 
:   Compute the cosine embedding loss. 

See [`CosineEmbeddingLoss`](torch.nn.CosineEmbeddingLoss.html#torch.nn.CosineEmbeddingLoss "torch.nn.CosineEmbeddingLoss")  for details. 
...
* **margin** ( [*float*](https://docs.python.org/3/library/functions.html#float "(in Python v3.13)") *,* *optional*  ) – Margin for cosine embedding. Has a default value of 0.
