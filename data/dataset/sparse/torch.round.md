...
torch. round ( *input*  , *** , *decimals = 0*  , *out = None* ) → [Tensor](../tensors.html#torch.Tensor "torch.Tensor") 
...
[`torch.ceil()`](torch.ceil.html#torch.ceil "torch.ceil")  , which rounds up. [`torch.floor()`](torch.floor.html#torch.floor "torch.floor")  , which rounds down. [`torch.trunc()`](torch.trunc.html#torch.trunc "torch.trunc")  , which rounds towards zero.

Parameters
:   * **input** ( [*Tensor*](../tensors.html#torch.Tensor "torch.Tensor")  ) – the input tensor.
* **decimals** ( [*int*](https://docs.python.org/3/library/functions.html#int "(in Python v3.13)")  ) – Number of decimal places to round to (default: 0).
