...
Tensor. put_ ( *index*  , *source*  , *accumulate = False* ) → [Tensor](../tensors.html#torch.Tensor "torch.Tensor") 
:   Copies the elements from `source`  into the positions specified by `index`  . For the purpose of indexing, the `self`  tensor is treated as if
...
* **source** ( [*Tensor*](../tensors.html#torch.Tensor "torch.Tensor")  ) – the tensor containing values to copy from
