...
Tensor. to_sparse_bsr ( *blocksize*  , *dense_dim* ) → [Tensor](../tensors.html#torch.Tensor "torch.Tensor") 
...
resulting BSR tensor. This argument should be used only if `self`  is a strided tensor, and must be a value between 0
