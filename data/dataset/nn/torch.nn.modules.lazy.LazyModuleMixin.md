...
*class* torch.nn.modules.lazy. LazyModuleMixin ( ** args*  , *** kwargs* ) [source](https://github.com/pytorch/pytorch/blob/v2.8.0/torch/nn/modules/lazy.py#L53) 
...
typical [`torch.nn.Linear`](torch.nn.Linear.html#torch.nn.Linear "torch.nn.Linear")  . 
...
For example, if the LazyMLP class defined above had a [`torch.nn.LazyLinear`](torch.nn.LazyLinear.html#torch.nn.LazyLinear "torch.nn.LazyLinear")  module
first and then a regular [`torch.nn.Linear`](torch.nn.Linear.html#torch.nn.Linear "torch.nn.Linear")  second, the second module would be
...
has_uninitialized_params ( ) [source](https://github.com/pytorch/pytorch/blob/v2.8.0/torch/nn/modules/lazy.py#L237) 
:   Check if a module has parameters that are not initialized.

initialize_parameters ( ** args*  , *** kwargs* ) [source](https://github.com/pytorch/pytorch/blob/v2.8.0/torch/nn/modules/lazy.py#L227) 
