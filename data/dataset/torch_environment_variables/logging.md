...
| [`set_logs`](generated/torch._logging.set_logs.html#torch._logging.set_logs "torch._logging.set_logs") | Sets the log level for individual components and toggles individual log artifact types. |
| --- | --- |

The environment variable `TORCH_LOGS`  is a comma-separated list of `[+-]<component>`  pairs, where `<component>`  is a component specified below. The `+`  prefix
