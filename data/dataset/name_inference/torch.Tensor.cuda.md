...
Tensor. cuda ( *device = None*  , *non_blocking = False*  , *memory_format = torch.preserve_format* ) → [Tensor](../tensors.html#torch.Tensor "torch.Tensor") 
...
Parameters
:   * **device** ( [`torch.device`](../tensor_attributes.html#torch.device "torch.device")  ) – The destination GPU device.
