...
*class* torch.nn. BatchNorm2d ( *num_features*  , *eps = 1e-05*  , *momentum = 0.1*  , *affine = True*  , *track_running_stats = True*  , *device = None*  , *dtype = None* ) [source](https://github.com/pytorch/pytorch/blob/v2.8.0/torch/nn/modules/batchnorm.py#L378) 
...
</math> -->( N , C , H , W ) (N, C, H, W)( N , C , H , W )  (same shape as input)
